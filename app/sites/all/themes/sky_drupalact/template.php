 ...
 */
function sky_drupalact_preprocess_html(&$vars) {
  global $theme_key;
 ...
 * Override or insert variables into the html template.
 */
function sky_drupalact_process_html(&$vars) {
 ...
 */
function sky_drupalact_preprocess_page(&$vars) {
 ...
 * Override or insert variables into the page template.
 */
function sky_drupalact_process_page(&$vars) {
  // Hook into the color module.
  if (module_exists('color')) {
 ...
 */
function sky_drupalact_preprocess_block(&$vars) {
 ...
 */
function sky_drupalact_preprocess_node(&$vars) {
 ...
 */
function sky_drupalact_preprocess_comment(&$vars) {
  // Add class if user picture exists
  if ($vars['picture']) {
 ...
 */
function sky_drupalact_process_region(&$vars) {
...
function sky_drupalact_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search-block-form') {
    $form['search-block-form']['#attributes']['placeholder'] = t('Search'); // Set a default value for the textfield
  }
}
